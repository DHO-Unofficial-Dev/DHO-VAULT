...
mod tests {
    ...
    fn classifies_verified_sd_block_range_boundaries() {
        for (start, end, expected) in [
            ...
            (8_857, 9_248, &["지도", "세계지도"]),
            (9_249, 9_274, &["미분류", "UI 이미지"]),
            (9_275, 9_290, &["던전", "함정 UI 이미지"]),
    ...
    fn resolves_verified_sd_assembly_rule_boundaries() {
        for (start, end, image_count, columns, rows, width, height) in [
            ...
            (3_511, 4_022, 1, 32, 16, 4_096, 2_048),
            ...
            (9_249, 9_254, 1, 3, 2, 272, 208),
            (9_255, 9_262, 1, 4, 2, 474, 226),
            (9_263, 9_266, 1, 2, 2, 256, 256),
            (9_267, 9_270, 1, 2, 2, 205, 233),
            (9_271, 9_274, 1, 2, 2, 200, 200),
            (9_284, 9_289, 1, 3, 2, 276, 226),
