...
const UNCLASSIFIED_COLOR_EFFECT_IMAGE: CategoryPath =
    CategoryPath::new(&["미분류", "색상·효과 이미지"]);
...
const WORLD_CLOCK: CategoryPath = CategoryPath::new(&["UI 이미지", "월드 클락"]);
...
pub(crate) const RECORD_RULES: &[RecordRule] = &[
    ...
    custom_range(3_508, 3_510, UNCLASSIFIED_COLOR_EFFECT_IMAGE),
    ...
    custom_range(8_769, 8_810, EVENT_ILLUSTRATION),
